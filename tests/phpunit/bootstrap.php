...
// Make CRM_SmartyUserContentPolicy_ExtensionUtil available.
require_once __DIR__ . '/../../smarty_user_content_policy.civix.php';
...
addExtensionToClassLoader('smarty-user-content-policy');
 ...
 */
function _smarty_user_content_policy_test_civicrm_container(ContainerBuilder $container): void {
}
